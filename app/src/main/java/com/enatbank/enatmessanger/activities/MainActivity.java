...
import com.enatbank.enatmessanger.adapters.ViewPagerAdapter;
...
public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, TabLayout.OnTabSelectedListener ,Chats.OnFragmentInteractionListener, Friends.OnFragmentInteractionListener{
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MaterialMenuInflater.with(this)
                ...
                .inflate(R.menu.main,  toolbar.getMenu());
